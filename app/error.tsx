    ...
    <section className="min-h-screen bg-accent-900 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="text-center relative">
        ...
        <p className="text-xl text-accent-300 mb-8 max-w-md mx-auto">
          Sorry, er is een onverwachte fout opgetreden. Probeer het opnieuw of neem contact met ons op.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            onClick={() => reset()}
            className="inline-flex items-center justify-center px-8 py-4 bg-primary-500 text-white font-bold rounded-xl shadow-lg hover:bg-primary-600 transition-all"
          >
